...
const home = () => {
  ...
  <div className="max-w-screen-lg py-14 sm:px-10 px-6  gap-4 h-full mx-auto flex md:flex-row flex-col justify-center items-center">
    ...
    <p className="text-gray-400 text-center py-4">I have over 3 years of experience. I specialize in building dynamic Web Applications and User Friendly Interfaces. My techstack includes React JS, Next JS, Tailwind, Redux etc.</p>
